    ...
    <>
      <div className='main-page'>
        ...
        <div >
          ...
          {displayText === 1 && <h2 className='animate__animated animate__backInLeft'> Eating Exotic Foods </h2>}
          {displayText === 2 && <h2 className='animate__animated animate__backInRight'> Eating Wazwan </h2>}
          {displayText === 3 && <h2 className='animate__animated animate__backInUp'> Eating Tibtan Food </h2>}
